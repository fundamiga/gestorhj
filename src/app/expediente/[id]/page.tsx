...
const tipoIcono: Record<string, string> = {
  'Hoja de Vida': '📄', 'Cédula de Ciudadanía': '🪪', 'Contrato': '📝',
  'Certificado de Estudios': '🎓', 'Certificado Laboral': '💼',
  'Examen Médico': '🏥', 'Afiliación EPS': '❤️', 'Afiliación Pensión': '🏦',
  'Afiliación ARL': '🦺', 'Paz y Salvo': '✅', 'Carta de Renuncia': '📮',
  'Acta de Liquidación': '📋', 'Otro': '📎',
};
